...
SECTOR_TO_NIFTY_GROUP = {
    "Energy": "NIFTY ENERGY", "Power": "NIFTY ENERGY", "Capital Goods": "NIFTY CAPITAL GOODS",
    "Consumer Durables": "NIFTY CONSR DURABLE", "Infra": "NIFTY INFRA", "Auto": "NIFTY AUTO",
    "Pvt Banks": "NIFTY BANK", "PSU Banks": "NIFTY PSU BANK", "NBFC": "NIFTY FINSERV",
    "Insurance": "NIFTY FINSERV", "Capital Markets": "NIFTY FINSERV", "Healthcare": "NIFTY HEALTHCARE",
    "Realty": "NIFTY REALTY", "IT": "NIFTY IT", "Pharma": "NIFTY PHARMA",
    "Chemicals": "NIFTY CHEMICALS", "Consumer": "NIFTY CONSUMPTION", "FMCG": "NIFTY FMCG",
    "Cement": "NIFTY CEMENT", "Metals": "NIFTY METAL",
}
...
def evaluate_scores(stock: dict, all_stocks: list[dict], nifty_pct_change: float, sector_means: dict[str, float]) -> dict:

...
@pytest.mark.asyncio
async def test_persist_and_get_candles():
    d = date(2026, 9, 1)
...
@pytest.mark.asyncio
async def test_get_all_today_candles_and_range():
    d1 = date(2026, 8, 31)
    d2 = date(2026, 9, 1)
...
@pytest.mark.asyncio
async def test_delete_candles_older_than():
    d1 = date(2026, 8, 1)
    d2 = date(2026, 9, 1)
...
@pytest.mark.asyncio
async def test_startup_snapshot_and_seed_missing_state():
    d0 = date(2026, 9, 1)
    d1 = date(2026, 8, 31)
